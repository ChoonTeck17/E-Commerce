            ...
            <div class="wg-box">
                ...
                <fieldset class="shortdescription">
                    ...
                    <textarea class="mb-10 ht-150" name="short_description"
                        ...
                        required="" value="{{$product->short_description}}"></textarea>
                    <div class="text-tiny">Do not exceed 100 characters when entering the
                        product name.</div>
                </fieldset>
                ...
                <div class="cols gap22">
                    <fieldset class="name">
                        ...
                        <input class="mb-10" type="text" placeholder="Enter regular price"
                            name="normal_price" tabindex="0" value="{{$product->normal_price}}" aria-required="true"
                            required="">
                    </fieldset>
                    ...
                    <fieldset class="name">
                        ...
                        <div class="select mb-10">
                            <select class="" name="stock_status">
                                <option value="instock" {{$brand->stock_status == "instock" ? "selected":"no"}}>InStock</option>
                                <option value="outofstock" {{$brand->stock_status == "outofstock" ? "selected":"no"}}>Out of Stock</option>
                            </select>
                        </div>
                    </fieldset>
                    ...
                    <fieldset class="name">
                        ...
                        <div class="select mb-10">
                            <select class="" name="featured">
                                <option value="0" {{$brand->featured == "0" ? "selected":"no"}}>>No</option>
                                <option value="1" {{$brand->featured == "1" ? "selected":"no"}}>>Yes</option>
                            </select>
                        </div>
                    </fieldset>
...
<script>
    ...
    $("#gFile").on("change", function(e){
        ...
        $("#galUpload .preview-item").remove(); // Clear old previews

        $.each(gphotos, function(key, val){
            const imgElement = `<div class="preview-item">
                                    <img src="${URL.createObjectURL(val)}" />
                                </div>`;
            $("#galUpload").append(imgElement); // Add previews after label
        });
    });
