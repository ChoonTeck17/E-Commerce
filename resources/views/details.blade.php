                ...
                <div class="swiper-wrapper">
                  ...
                  <div class="swiper-slide product-single__image-item">
                    <img loading="lazy" class="h-auto" src="{{asset('uploads/products')}}/{{$product->image}}" width="674"
                      height="674" alt="" />
                    <a data-fancybox="gallery" href="{{asset('uploads/products')}}" data-bs-toggle="tooltip"
              ...
              <div class="swiper-container">
                <div class="swiper-wrapper">
                  <div class="swiper-slide product-single__image-item"><img loading="lazy" class="h-auto"
                      src="{{asset('uploads/products/thumbnail')}}/{{$product->image}}" width="104" height="104" alt="" /></div>
                      @foreach (explode(',', $product->images) as $gimg)
                  <div class="swiper-slide product-single__image-item"><img loading="lazy" class="h-auto"
                      src="{{asset('uploads/products/thumbnail')}}/{{$gimg}}" width="104" height="104" alt="" /></div>
                      @endforeach
                </div>
              </div>
            </div>
            ...
            <div class="swiper-slide product-card">
              <div class="pc__img-wrapper">
                <a href="{{route('shop.product.details', ['product_slug' => $rproduct->slug])}}">
                  ...
                  alt="{{ $rproduct->name }}" 
                  class="pc__img" 
                  data-gallery="{{ $rproduct->image . ',' . $rproduct->images }}"
              >
              ...
              <div class="pc__info position-relative">
                ...
                <div class="product-card__price d-flex">
                  ...
                  <s>${{$product->normal_price}}</s> ${{$rproduct->sale_price}}
                  @else
