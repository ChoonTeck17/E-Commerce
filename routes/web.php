...
route::get('shop/contactus',[ShopController::class, 'contact'])->name('shop.contactus');
...
route::delete('cart/remove_coupon', [CartController::class, 'remove_coupon'])->name('cart.remove_coupon');
...
route::get('/order/success', [CartController::class, 'order_success'])->name('cart.order_success');
